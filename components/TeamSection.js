...
const TeamSection = () => {
  ...
  const teamMembers = [
    {
      name: 'DxSale',
      image: '/dxsale.png', // Replace with actual image path
    },
    {
      name: 'BNB Chain',
      image: 'https://th.bing.com/th/id/OIP.1wTTp6-XPR-g6PS8D8ZAqAHaDt?pid=ImgDet&rs=1', // Replace with actual image path
    },
    {
        name: 'Coinbase',
